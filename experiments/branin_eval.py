...
from utils import gen_example_2d_plot, branin, save_plotted_progress, plot_results
...
def worker(i):
    ...
    tpe_optimizer_long = branin_tpe_search(n_iterations=N_BRANIN_ITERS, random_seed=i, n_EI_candidates=100, name='TPE_long')
