...
rs_optimizer = example_2d_random_search(n_iterations=25)
ga_optimizer = example_2d_ga_search(n_iterations=25)
gp_optimizer = example_2d_gp_search(n_iterations=25, gp_n_iter=25, gp_n_warmup=1000)
tpe_optimizer = example_2d_tpe_search(n_iterations=25)
